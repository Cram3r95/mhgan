...
from sophie.modules.decoders import CGH_GoalMMDecoderLSTM, GoalMMDecoderLSTM
...
class TrajectoryGenerator(nn.Module):
    def __init__(
        ...
        self.decoder = CGH_GoalMMDecoderLSTM(h_dim=self.h_dim, n_samples=n_samples)
    ...
    def forward(self, obs_traj, obs_traj_rel, goal_points, start_end_seq, agent_idx=None):
        ...
        ## add noise to decoder input (TODO: Only for GANs??)
